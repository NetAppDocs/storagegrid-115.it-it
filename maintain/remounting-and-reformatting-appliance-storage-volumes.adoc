...
. Tornare alla pagina Installazione monitor del programma di installazione dell'appliance StorageGRID immettendo `\http://Controller_IP:8080`, Utilizzando l'indirizzo IP del controller di calcolo.
+
