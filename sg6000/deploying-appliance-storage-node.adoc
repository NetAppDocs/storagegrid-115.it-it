...
NOTE: Se si sta implementando l'appliance Storage Node come destinazione di clonazione del nodo, interrompere il processo di implementazione e continuare la procedura di clonazione del nodo in fase di ripristino e manutenzione. +link:../maintain/index.html["Mantieni  Ripristina"]
