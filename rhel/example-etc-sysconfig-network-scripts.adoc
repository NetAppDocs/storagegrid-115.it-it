...
sidebar: sidebar 
keywords:  
summary: 'È possibile utilizzare i file di esempio per aggregare quattro interfacce fisiche Linux in un unico collegamento LACP e quindi stabilire tre interfacce VLAN che sottendere il collegamento per l"utilizzo come interfacce di rete StorageGRID, amministratore e client.' 
---
...
[role="lead"]
È possibile utilizzare i file di esempio per aggregare quattro interfacce fisiche Linux in un unico collegamento LACP e quindi stabilire tre interfacce VLAN che sottendere il collegamento per l'utilizzo come interfacce di rete StorageGRID, amministratore e client.
